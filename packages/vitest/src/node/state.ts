...
export class StateManager {
  ...
  transformTime = 0
  /**
   * Time spent transforming modules, split by project name. Used by
   * performance diagnostics to relate a project's environment cost to the
   * rest of its tracked time.
   */
